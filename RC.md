...
Рекомендательные системы (РС) — программные системы, предназначенные для оценки уровня интереса пользователя к определенному продукту или сервиса, на основе имеющейся информации о пользователе и/или продукте и сервисе.
...
Существует ряд подходов к оценке интереса:
  ...
  3. смешанные методы, которые базируются на подходах пп. 1 и 2 одновременно.
...
Nadim Hossain. Why the Interest Graph Is a Marketer’s Best Friend (англ.). Mashable. Проверено 7 декабря 2013.
wikipedia
